...
public class TicTacToeGameSinglePlayer {
    ...
    public void play() {
        while (true) { // game loop
            ...
            if (finished) break;
            ///////////////////////////////////////////
            CPUMoveGenerator cpuMove = new CPUMoveGenerator(this);
            move = cpuMove.getMove();
            System.out.println("CPU move: " + move);
            update();
    ...
    public static boolean isWinningCombo(String slot1, String slot2, String slot3) {
